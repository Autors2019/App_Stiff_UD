...
public class PorticoMatrixOrderActivity extends AppCompatActivity  implements InterfaceMatrixOrden, InterfaceValidadores {
    // Objetos recibidos
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     public ArrayList<String> numeroGradosLibertad(int numeroElementos) {
